...
export const popupCardSelector = document.querySelector('.popup_type_add-card');
export const popupPreviewImageSelector = document.querySelector('.popup_type_preview-image');
